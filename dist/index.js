...
(function (factory) {
    ...
    class TinkoffApi {
        ...
        constructor(terminalKey, secretKey) {
            ...
            (0, debug_1.default)(`Initialized with terminalKey=${this.terminalKey}`);
        }
        /**
        ...
        generateToken(params) {
            ...
            const token = crypto
                ...
                .digest('hex');
            (0, debug_1.default)(`generateToken digest is ${token}`);
            return token;
        }
        /**
         * Request API method
        ...
        requestMethod(methodName, params) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                (0, debug_1.default)(`Send '${methodName}' with ${methodParams}`);
                ...
                if (!response.data.Success) {
                    (0, debug_1.default)(`Error: [${response.data.Message}] ${JSON.stringify(response.data)}`);
                }
